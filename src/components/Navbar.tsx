        ...
        <div className="flex-none">
          ...
          <div className="dropdown dropdown-end md:hidden">
            ...
            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-4 shadow-lg bg-secondary/95 backdrop-blur-sm rounded-box w-52 border border-accent/10">
              <li><Link href="/#horarios" className="text-accent hover:text-primary hover:bg-accent/5 py-3 transition-colors duration-300">Horarios</Link></li>
              <li><Link href="/#tarifas" className="text-accent hover:text-primary hover:bg-accent/5 py-3 transition-colors duration-300">Tarifas</Link></li>
              <li><Link href="/#disciplinas" className="text-accent hover:text-primary hover:bg-accent/5 py-3 transition-colors duration-300">Disciplinas</Link></li>
              <li><Link href="/requisitos" className="text-accent hover:text-primary hover:bg-accent/5 py-3 transition-colors duration-300">¿Qué necesitas?</Link></li>
              <li><Link href="/#contacto" className="text-accent hover:text-primary hover:bg-accent/5 py-3 transition-colors duration-300">Contacto</Link></li>
